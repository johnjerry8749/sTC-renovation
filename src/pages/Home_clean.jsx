        ...
        <Container>
          <Row className="align-items-center min-vh-100">
            <Col lg={6} className="hero-content">
              ...
              <p className="hero-subtitle fade-in-up fade-in-delay-1">
            ...
            <Col lg={6} className="text-center fade-in-up fade-in-delay-3">
      ...
      <section className="section-padding section-white">
        <Container>
          ...
          <Row>
            ...
            <Col lg={4} md={6} className="mb-4">
              <div className="service-card fade-in-up fade-in-delay-1">
                <div className="service-icon">
            ...
            <Col lg={4} md={6} className="mb-4">
              <div className="service-card fade-in-up fade-in-delay-2">
                <div className="service-icon">
        ...
        <Container>
          ...
          <Row>
            <Col lg={3} md={6} className="mb-4">
              <div className="feature-box text-center fade-in-up">
            ...
            <Col lg={3} md={6} className="mb-4">
              <div className="feature-box text-center fade-in-up fade-in-delay-1">
                <div className="feature-icon">
            ...
            <Col lg={3} md={6} className="mb-4">
              <div className="feature-box text-center fade-in-up fade-in-delay-2">
                <div className="feature-icon">
            ...
            <Col lg={3} md={6} className="mb-4">
              <div className="feature-box text-center fade-in-up fade-in-delay-3">
                <div className="feature-icon">
